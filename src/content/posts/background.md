...
- Led programming for VEX Robotics Competition team [315P](https://www.robotevents.com/teams/V5RC/315P) (5+ awards including 3x tournament finalist, 1x tournament champion, 1x excellence award world division quarterfinalists). [code](https://github.com/aadishv/highstakes) [blog post 1](/robotics-1/) [blog post 2](/robotics-2/)
- Led AI programming for VEX AI Robotics Competition team 3151A, including work on system design, training & running custom CV pipeline, and handling serial communications between VEX and NVIDIA hardware. Designed and wrote >9,000 lines of C++, Python, TypeScript, Rust, and shell. Also explored future-leaning work for the team that pushed the state of the art in VEX Robotics, such as GPU-accelerated Monte Carlo localization via a LiDAR. [blog post 1](/robotics-3/) [blog post 2](/robotics-4/) [code (24-25)](https://github.com/aadishv/AIWorlds) [code (25-26)](https://github.com/aadishv/3151a-zenoh)
...
- [Advent of Code](https://adventofcode.com/2024) 2024 participant [[code](https://github.com/aadishv/aoc) [blog post](/aoc)]
