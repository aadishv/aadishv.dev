...
Hundreds if not thousands of VEX teams utilize LemLib to handle their motion controls for them. Unfortunately, a significant number of them likely don't understand the algorithms they are using. Further unfortunately, even I didn't understand how many of LemLib's motion control algorithms worked when I used them.
...
Unfortunately, a [V5RC Q&A (asked _and_ answered by the Game Design Comittee :P)](https://qnapl.us/#/2812) recently clarified that (emphasis mine):
...
![LaTeX image](https://latex.codecogs.com/svg.image?%5Ctext%7BPID%7D(%5Ctext%7Berror%7D)%20%3D%20K_p%20%5Ccdot%20%5Ctext%7Berror%7D%20%5Ccdot%20K_i%20%5Ccdot%20%5Ctext%7Btotal%20error%7D%20%2B%20K_p%20%5Ccdot%20%5Ctext%7Bchange%20in%20error%7D)
