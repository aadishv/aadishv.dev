...
export function CosineViz() {
  ...
  const calculateAngle = () => {
    ...
    const angleToPoint =
      (Math.atan2(target.y - box.y, target.x - box.x) * 180) / Math.PI;
  ...
  return (
    <div class="mx-auto w-[800px]">
      <div class="flex h-[18rem] flex-col rounded-none">
        <div class="my-auto">
          <p class="text-[1.5rem] text-wrap">
      ...
      <svg
        ...
        width="800"
        height="600"
        class="mx-auto my-auto cursor-crosshair"
