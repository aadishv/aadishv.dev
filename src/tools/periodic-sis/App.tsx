...
const [textColors, setTextColors] = useState<Record<ElementTypeString, string>>({ ...TEXT_COLORS });
const [bgColors, setBgColors] = useState<Record<ElementTypeString, string>>({ ...BG_COLORS });
...
return (
  <>
    <Table elementRefs={elementRefs} textColors={textColors} bgColors={bgColors} />
    <div
